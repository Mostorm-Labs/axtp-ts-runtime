...
import { type Bytes } from "../core/support/io/bytes.js";
import { ErrorCode, RpcBodyEncoding, RpcEncoding, RpcOp } from "../core/protocol/generated/axtp_ids_generated.js";
import { defaultPayloadMeta, rpcPayload, SourceProtocol, type RpcPayload } from "../core/protocol/model/model.js";
import type { ByteSink } from "../core/support/io/io.js";
import type { AxtpEndpoint } from "../core/runtime/endpoint/endpoint.js";
import { AxtpWireMode, type ITransport, type TransportProfile } from "../core/runtime/transport/transport.js";
